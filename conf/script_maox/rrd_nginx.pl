...
#my $rrd = '/usr/share/nginx/html/rrd';
my $rrd = '/var/www/html/monitor/rrd';
# define location of images
#my $img = '/usr/share/nginx/html';
my $img = '/var/www/html/monitor';
# define your nginx stats URL
my $URL = "http://85.234.146.73/nginx_status";
#my $URL = "http://85.234.146.73/nginx_status";
